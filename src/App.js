...
import BackgroundImg from '../src/img/Bord_3hram.png'
...
function App() {
  ...
  return (
        <div className="App-content" style={{ backgroundImage: `url(${BackgroundImg})`, backgroundColor: '#445B6D', backgroundSize: 'auto 100vh', backgroundPosition: 'top left', backgroundRepeat: 'no-repeat', backgroundAttachment: 'fixed' }}>
